function numeric()
    ...
    for i=1:data.numbers
        data.images{i} = imread([path  num2str(i) '.jpg']);
    end;
            ...
            if(size(first_ltr,1)>0)
                for js = first_ltr
                    ...
                    for k=js:js+length-1
                        ...
                        if(same)
                            change_color(uib, data.images{abs(data.matrix(i,k))}, 0, -1, -1);
                        else
                            change_color(uib, data.images{abs(data.matrix(i,k))}, 0, -1, 127);
                        end;
                    end
            ...
            if(size(first_ltr, 1)>0)
                for js = first_ltr
                    ...
                    for k=js:js+length-1
                        ...
                        if(same)
                            change_color(uib, data.images{abs(data.matrix(k,j))}, 0, -1, -1);
                        else
                            change_color(uib, data.images{abs(data.matrix(k,j))}, 0, -1, 127);
                        end;
